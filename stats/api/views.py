    ...
    @extend_schema(
        ...
        responses=inline_serializer(
            "Stats",
            {
                ...
                "home_status": inline_serializer(
                    "HomeStatusCounts", {status: serializers.IntegerField() for status in Home.HomeStatus.values}
                ),
                "monthly_sales": inline_serializer(
                    "MonthlySales",
                    {
                ...
                "monthly_revenue": inline_serializer(
                    "MonthlyRevenue",
                    {
                        "month": serializers.CharField(),
                ...
                "lead_sources": inline_serializer(
                    "LeadSources",
                    {
