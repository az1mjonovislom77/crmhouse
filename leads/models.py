...
BOARD_STATUSES = {"sales": SALES_STATUSES, "cold": COLD_STATUSES}
...
class Lead(models.Model):
    ...
    owner = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, related_name="owned_leads"
    )
...
class LeadNotification(models.Model):
    ...
    owner = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="lead_notifications")
