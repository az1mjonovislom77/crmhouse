...
class Command(BaseCommand):
    help = (
        "Bazadagi rasmlarni webp'ga qayta siqadi. Bir nechta yozuv bitta faylni "
    ...
    def _repair(self, dry):
        ...
        self.stdout.write(
            self.style.SUCCESS(f"{prefix}Tuzatildi: {repaired} | hali yo'q (.webp topilmadi): {still_missing}")
        )
