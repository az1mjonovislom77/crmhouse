    ...
    return (
        ...
        .annotate(
            ...
            available_homes=Count(
                "blocks__homes", filter=Q(blocks__homes__home_status=Home.HomeStatus.AVAILABLE), distinct=True
            ),
            sold_homes=Count("blocks__homes", filter=Q(blocks__homes__home_status=Home.HomeStatus.SOLD), distinct=True),
        )
        .annotate(
            sold_percent=Case(
